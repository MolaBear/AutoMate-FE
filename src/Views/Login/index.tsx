...
export default Login;
  ...
  //   const Login = () => {
  //     const [empID, setEmpID] = useState("");
  //     const [forgotPassID, setForgotPassID] = useState("");
  ...
  //         navigate("setpass");
  //       } else if (empID === "Trainee" && pass === "Password123!") {
  //         console.log("trainee in, take me to home");
  ...
  //                     </label>
  //                     <br/><br/>
  //                     <InputField1 value={forgotPassID} onChange={(e) => setEmpID(e.target.value)} type="text" placeholder="Employee Code" id="empID" name="empID" width="100%" /><br/>
